...
echo "<title>History Now Podcast</title>"
echo "<image>"
echo "     <url>http://tomwsmf.com/podcasts/mrpeabodylogo.jpg</url>"
echo "     <title>History Now Podcast</title>"
echo "     <link>http://tomwsmf.com/blog</link>"
echo "</image>"
echo "<link>http://tomwsmf.com/blog</link>"
echo "<description>Sounds from the history of today.</description>"
echo "<itunes:summary>Sounds from the history of today..</itunes:summary>"
echo "<itunes:owner>"
...
echo "<itunes:email>shepaday@tomwsmf.com</itunes:email>"
echo "<itunes:image href='http://tomwsmf.com/podcasts/mrpeabodylogo.jpg' />"
...
grep  "$today" /home/tomwsmf/history/mrpeabodylist.txt|sed "s/insertdate/$pubdate/g"
echo "</channel>"
echo "</rss>"
